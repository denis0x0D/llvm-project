...
module attributes {gpu.container_module} {
  ...
  llvm.func @foo() {
    ...
    llvm.call @__vulkanLaunch(%16, %16, %16, %16, %16, %16, %17, %18, %19, %20, %21) {SPIRVEntryPoint = "kernel", SPIRV_BIN = "\03\02#\07\00"}
    : (!llvm.i64, !llvm.i64, !llvm.i64, !llvm.i64, !llvm.i64, !llvm.i64, !llvm<"float*">, !llvm<"float*">, !llvm.i64, !llvm.i64, !llvm.i64) -> ()
    llvm.return
  }
  llvm.func @__vulkanLaunch(!llvm.i64, !llvm.i64, !llvm.i64, !llvm.i64, !llvm.i64, !llvm.i64, !llvm<"float*">, !llvm<"float*">, !llvm.i64, !llvm.i64, !llvm.i64)
}
