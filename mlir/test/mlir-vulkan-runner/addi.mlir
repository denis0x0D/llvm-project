...
module attributes {
  ...
  gpu.module @kernels {
    gpu.func @kernel(%arg0 : memref<8xi32>, %arg1 : memref<8x8xi32>, %arg2 : memref<8x8x8xi32>)
  ...
  func @main() {
    ...
    "gpu.launch_func"(%cst8, %cst8, %cst8, %cst1, %cst1, %cst1, %arg0, %arg1, %arg2) { kernel = "kernel", kernel_module = @kernels }
